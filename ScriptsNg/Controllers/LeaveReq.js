...
app.controller('LeaveReqCtrl', ['$scope', 'CRUDService', 'uiGridConstants',
...
debugger;
            ...
            var apiRoute = 'LeaveRequest/LeaveRequestAng/' + NextPage + '/' + NextPageSize;
            var result = CRUDService.getProducts(apiRoute);
            result.then(
                function (response) {
                    $scope.pagination.totalItems = response.data.recordsTotal;
                    $scope.gridOptions.data = response.data.leavereqList;
